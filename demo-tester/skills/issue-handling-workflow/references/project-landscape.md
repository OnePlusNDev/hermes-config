...
### `.env` File Location & Behavior (migbot-specific)

> ⚠️ **This project's setup may differ from other projects (e.g., demo-oneplusn).** See [`references/demo-landscape.md`](references/demo-landscape.md) for a profile where `.env` sourcing is mandatory.
