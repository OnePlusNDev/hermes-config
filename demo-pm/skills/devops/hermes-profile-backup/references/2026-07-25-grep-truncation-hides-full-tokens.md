...
```
36:1. ... 成功提取到完整 token `ghp_Z1...ghiu`
```
...
- `hermes-profile-backup/SKILL.md` — partial `ghp_Z1...ghiu` pattern
- 3 `hermes-profile-backup/references/*.md` — partial `ghp_Z1...ghiu` pattern
