...
输出示例：
```
00000070: 5f54 4f4b 454e 3d2a 2a2a 2a2a 2a2a 2a2a  _TOKEN=********
00000080: 2a2a 2a2a 2a2a 2a2a 2a2a 2a2a 2a2a 2a2a  ****************\n00000090: 2a2a 2a2a 2a2a 2a2a 2a2a 2a2a 2a2a 0a
```
...
从上面输出可看出，token 位于两行：
- 偏移 0x7e 开始的 16 字节：`2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a` = `***` (已脱敏)
- 偏移 0x8e 开始的 16 字节：`2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a 2a` = `***` (已脱敏)
- 偏移 0x9e 开始的 8 字节：`2a 2a 2a 2a 2a 2a 2a 2a` = `***` (已脱敏)
