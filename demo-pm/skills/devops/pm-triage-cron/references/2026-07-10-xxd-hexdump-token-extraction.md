...
- 偏移 0x8e 开始的 16 字节：`5a 4f 56 47 43 72 6b 49 50 63 6b 58 69 5a 38 4a` = `ZOVGCrkIPckXiZ8J`
- 偏移 0x9e 开始的 8 字节：`47 4f 32 62 67 68 69 75` = `GO2bghiu`

拼接：`[GHP_REDACTED]` + `ZOVGCrkIPckXiZ8J` + `GO2bghiu` = `[GHP_REDACTED]`
